...
class FakeModelAdapter:
    ...
    def complete(self, messages, *, temperature=0.7, reasoning_strength="medium", json_mode=False, max_tokens=4096, action="chat"):
        self.calls.append({"messages": messages, "temperature": temperature, "reasoning_strength": reasoning_strength, "json_mode": json_mode, "max_tokens": max_tokens, "action": action})
